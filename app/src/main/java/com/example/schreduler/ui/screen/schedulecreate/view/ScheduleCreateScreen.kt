package com.example.schreduler.ui.screen.schedulecreate.view
...
import com.example.schreduler.ui.screen.schedulecreate.view.composables.CountEmployeesPerDayDropMenu
import com.example.schreduler.ui.screen.schedulecreate.view.composables.EmployeeCardWithNoWorkingDays
import com.example.schreduler.ui.screen.schedulecreate.viewmodel.ScheduleCreateViewModel

class ScheduleCreateScreen: Screen {
    @Composable
    override fun Content() {

        val navigator = LocalNavigator.currentOrThrow

        val viewModel: ScheduleCreateViewModel = getViewModel()
